...
hist(as.numeric(cleaned_SF$Number.of.Ratings[which(cleaned_SF$Number.of.Ratings != "0"),]))
hist(as.numeric(cleaned_SF$Weekly.Downloads))
hist(as.numeric(cleaned_SF$Weekly.Downloads[which(cleaned_SF$Weekly.Downloads != "0"),]))
...
#plot date registered and last updated over time!
