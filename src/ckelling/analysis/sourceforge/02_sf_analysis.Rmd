...
```{r}
# source(file='~/git/comm_roanoke/src/ckelling/functions_and_inputs/sent_analysis_function.R')
# source('~/git/comm_roanoke/src/ckelling/functions_and_inputs/text_mining_funs.R')
# source('~/git/comm_roanoke/src/ckelling/functions_and_inputs/vectorurl_wordsfunction.R')
# 
# 
# all_words <- as.data.frame(get_words(as.data.frame(cleaned_SF$Description)))
# 
# 
# 
# library(SnowballC)
...
# dps_chrg_corpus <- Corpus(VectorSource(cleaned_SF$Description))
...
#     res=72
# )
# wordcloud(dps_d$word, dps_d$freq, min.freq = 1, random.order = FALSE, colors=brewer.pal(8, "Dark2"))
# dev.off()
